...
<body>
  ...
  <div class="container mb-5">
    <div class="row justify-content-center">
      <div class="card mt-5">
        <div class="card-body">
          <h2 class="card-title text-center mb-4">Restaurant Ekle</h2>
          <a href="/panels/company/index.php" class="btn btn-secondary">Geri</a>
          <div class="container mt-3">
            <form action="/panels/company/add-restaurant.php" method="POST">
              <input type="hidden" name="company_id" id="company_id"
                value="<?php echo $_SESSION["user"]["company_id"] ?>">
              <div class="mb-3">
                <label for="name" class="form-label">Restaurant Adı</label>
